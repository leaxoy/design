...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.example.design.authorization.annotation.Authorization)")
    public void authorizationAspect() {
    }

    @Pointcut("@annotation(com.example.design.authorization.annotation.CurrentUser)")
    public void currentUserAspect() {
    }

    @Pointcut("execution(public * com.example.design.service..*.all(..))")
    public void getAllAspect() {
